    ...
    <div class="py-12 bg-gray-100">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Create New Branch</h1>
                    <p class="mt-1 text-sm text-gray-600">Add a new update branch for your application.</p>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('update_manager.branches.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                placeholder="Optional description of this branch">{{ old('description') }}</textarea>
                        </div>
