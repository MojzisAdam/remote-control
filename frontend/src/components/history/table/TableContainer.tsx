...
const TableContainer: React.FC<CustomGraphsContainerProps> = ({ deviceId }) => {
	...
	const loadHistoryData = async () => {
		try {
			const response = await loadPaginatedDeviceHistory(deviceId, query.page, query.pageSize, query.fromDate || undefined, query.toDate || undefined, query.errorOnly);
