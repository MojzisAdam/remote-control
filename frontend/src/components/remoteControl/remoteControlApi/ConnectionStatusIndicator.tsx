...
const ConnectionStatusIndicator: React.FC<ConnectionStatusProps> = ({ deviceConnectionStatus, lastMessageTimestamp, retryConnection, error }) => {
				...
				<HoverClickPopover
					...
					content={
						<div className="max-w-xs">
							<p className="font-semibold leading-none mb-1">{config.label}</p>
